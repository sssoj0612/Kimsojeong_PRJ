...
public class MailService implements IMailService {
    ...
    public int doSendMail(MailDTO pDTO) {
        ...
        String toMail = kopo.kimsojeong_prj.util.CmmUtil.nvl(pDTO.getToMail()); // 받는이
        String title = kopo.kimsojeong_prj.util.CmmUtil.nvl(pDTO.getTitle()); // 메일제목
        String contents = kopo.kimsojeong_prj.util.CmmUtil.nvl(pDTO.getContents()); // 메일내용
